 ...
 *
 * @param portTx The GPIO port to use for transmitting.
 * @param bitTx The GPIO port bit to use for transmitting.
 * @param portRxx The GPIO port to use for receiving.
 * @param bitRx The GPIO port bit to use for receiving.
 */
